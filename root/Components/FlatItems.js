...
export default function FlatItems(props){
    ...
    return(
        <View style={{flexDirection:'column', borderWidth:1.2, width:173, height:187, borderColor:theme.colors.secondary, borderRadius:8, backgroundColor:theme.colors.primary, elevation:10, justifyContent:'space-between'}}>
            ...
            style={{height:30, width:91, marginLeft:28, marginTop:7.5, justifyContent:'center', alignItems:'center'}}>
                <Text style={{color:theme.colors.primary, fontSize:16, fontWeight:'500'}}>₤{props.price}/<Text style={{fontSize:13}}>pd</Text></Text>
            </ImageBackground>
            </View>
        </View>
    )
